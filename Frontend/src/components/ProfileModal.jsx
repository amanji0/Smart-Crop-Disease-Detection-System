  ...
  return (
    <div className="modal-overlay" onClick={onClose} style={{
      ...
      <div className="modal-content" onClick={e => e.stopPropagation()} style={{
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '24px' }}>
          Your Profile
        </h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '32px' }}>
          ...
          <button onClick={handleSave} disabled={loading} className="btn-primary" style={{ width: '100%', justifyContent: 'center' }}>
