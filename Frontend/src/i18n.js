const translations = {
  en: {
    ...
    modalDiseaseTitle: "🔬 Scan & Diagnose",
    ...
    logout: "Logout",
    // New section label & title keys
    whatWeDoLabel: "FEATURES",
    whatWeDoTitle: "What We Do",
    simpleLabel: "HOW IT WORKS",
    simpleTitle: "Simple as 1-2-3",
    farmersLoveLabel: "TESTIMONIALS",
    farmersLoveTitle: "Farmers Love Us",
    knowCropsLabel: "CROP LIBRARY",
    knowCropsTitle: "Know Your Crops",
    scanLabel: "AI DIAGNOSTICS",
    scanTitle: "Scan & Diagnose",
    heroBadge: "FARMING MEETS INTELLIGENCE",
  },
  hi: {
    ...
    modalDiseaseTitle: "🔬 स्कैन और निदान",
    ...
    logout: "लॉग आउट",
    // New section label & title keys
    whatWeDoLabel: "विशेषताएं",
    whatWeDoTitle: "हम क्या करते हैं",
    simpleLabel: "कैसे काम करता है",
    simpleTitle: "1-2-3 जितना आसान",
    farmersLoveLabel: "प्रशंसापत्र",
    farmersLoveTitle: "किसान हमें पसंद करते हैं",
    knowCropsLabel: "फसल पुस्तकालय",
    knowCropsTitle: "अपनी फसलें जानें",
    scanLabel: "एआई निदान",
    scanTitle: "स्कैन और निदान",
    heroBadge: "खेती और बुद्धिमत्ता का मिलन",
  },
  // Regional languages — partial keys with fallback to Hindi then English
